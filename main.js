...
// for (let i = 0; i < trivia.length; i++) {
//     let correctAnswer = trivia[i].results.correct_answer
//     //let category = trivia[i].results.category
//     //let question = trivia[i].results.question 
//     document.querySelector('hidden').appendChild(correctAnswer)
// }
// })
